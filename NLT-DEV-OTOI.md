...
|---|---|---|---|
| ORG-DEV-OTOI-1.0.3 | 2026-08-04 | OpenCode CTO Orchestrator | Bumped OTOI version to align with canonical governance contract in `.github-private/NLT-DEV-OTOI.md`. Updated all `otoi_version` references and document ID from `1.0.2` to `1.0.3`. |
